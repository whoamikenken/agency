    ...
    public function generateReport(Request $request)
    {
        ...
        if($formFields['tag'] == "hrreport"){
            ...
            foreach ($data['result'] as $key => $value) {
                ...
                if (isset($data['result'][$key]->user_profile_face)) $data['result'][$key]->user_profile_face = Storage::disk('empsys')->url($value->user_profile_face);
                if (isset($data['result'][$key]->user_profile)) $data['result'][$key]->user_profile = Storage::disk('empsys')->url($value->user_profile);
            }
            ...
            foreach ($data['result'] as $key => $value) {
                ...
                if (isset($data['result'][$key]->branch)) $data['result'][$key]->branch = DB::table('branches')->where('code', $value->branch)->value('description');
                if (isset($data['result'][$key]->passport_place_issued)) $data['result'][$key]->passport_place_issued = DB::table('countries')->where('code', $value->passport_place_issued)->value('description');
                if (isset($data['result'][$key]->passport)) $data['result'][$key]->passport = Storage::disk('empsys')->url($value->passport);
                if (isset($data['result'][$key]->user_profile_face)) $data['result'][$key]->user_profile_face = Storage::disk('empsys')->url($value->user_profile_face);
                if (isset($data['result'][$key]->user_profile)) $data['result'][$key]->user_profile = Storage::disk('empsys')->url($value->user_profile);
            }
