                    ...
                    <div class="row g-0">
                        <div class="col-4">
                            @if ($item->user_profile)
                                <img src="{{ asset('storage/'.$item->user_profile.'')}}" id="{{$item->applicant_id}}" class="img-fluid user_photo_list rounded animate__animated animate__fadeIn animate__delay-1s m-2" alt="..." style="height: -webkit-fill-available;">
                            @else
