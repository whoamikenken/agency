                        ...
                        <div class="col-sm-12 col-md-6 col-lg-3">
                            <div class="card mb-3 shadow" >
                                <div class="row g-0">
                                    <div class="col-4">
                                        @if ($item->user_image)
                                            <img src="{{  Storage::disk('empsys')->url($item->user_image)}}" class="img-fluid user_photo_list rounded animate__animated animate__fadeIn animate__delay-1s m-2" alt="..." style="height: -webkit-fill-available;">
                                        @else
                                            @if ($item->gender == "male")
